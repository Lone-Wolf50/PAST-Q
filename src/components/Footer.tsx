...
const buildSections = (openContact: (s?: string) => void): FooterSection[] => [
  {
    ...
    links: [
      ...
      { label: 'Cortana AI Tutor', href: '/ask-ai', desc: 'Instant AI explanations',
        popover: { title: 'Cortana AI Tutor', content: 'Get instant step-by-step explanations on any past paper question, 24/7.' } },
